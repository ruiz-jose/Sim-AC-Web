...
export default class Cpu {
	...
	constructor() {
		...
		this.programCounter = writable(new BinaryValue(5, FIRST_ADDRESS))
		this.increment = writable<BinaryValue>(new BinaryValue(5, WORD_SIZE))
		this.alu1 = writable<BinaryValue>(new BinaryValue(8, 0))
		this.alu2 = writable<BinaryValue>(new BinaryValue(8, 0))
		this.aluOperation = writable<Operators>("")
		this.aluResult = writable<BinaryValue>(new BinaryValue(8, 0))
		this.accumulator = writable<BinaryValue>(new BinaryValue(8, 0))
		this.zeroFlag = writable<boolean>(false)
	...
	public reset(): void {
		...
		this.programCounter.set(new BinaryValue(5, FIRST_ADDRESS))
		this.increment.set(new BinaryValue(5, WORD_SIZE))
		this.alu1.set(new BinaryValue(8, 0))
		this.alu2.set(new BinaryValue(8, 0))
		this.aluOperation.set("")
		this.aluResult.set(new BinaryValue(8, 0))
		this.accumulator.set(new BinaryValue(8, 0))
		this.zeroFlag.set(false)
